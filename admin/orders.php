                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn  btn-outline-info"><a style="text-decoration: none; color:black;" href="products.php?id=<?php echo $data[$i]['pdt_id'] ?>">Product details</a></button>

        ...
        ?>
            ...
            <form action="customers.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="<?php echo $data[0]['user_email'] ?>" name="email">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $data[$i]['user_email'] ?></td>

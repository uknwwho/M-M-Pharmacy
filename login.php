...
<head>
    ...
    <title>M&M Pharmacy - Login</title>
            ...
            <form id="loginform" role="form" method="post" action="login.php">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id="login-username" type="email" class="form-control" name="userEmail" placeholder="Enter your email" required>
                    </div>
                </div>
                ...
                <!-- Signup and Admin Login Links -->
                <div class="form-group text-center">
                    <p>Don't have an account? <a href="signUp.php" class="signup-link">Sign Up Here</a></p>
                    <p><a href="admin/login.php" class="admin-login-link">Sign In as Admin</a></p>
                </div>
            </form>
        </div>
    </div>
